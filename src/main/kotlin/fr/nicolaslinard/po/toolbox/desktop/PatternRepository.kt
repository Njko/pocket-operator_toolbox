...
interface PatternRepository {
    ...
    fun save(pattern: PO12Pattern): File
    fun update(originalFile: File, updatedPattern: PO12Pattern): File
...
class FilePatternRepository(
    ...
    override fun save(pattern: PO12Pattern): File {
        baseDir.mkdirs()
        return writer.write(pattern, baseDir)
    }

    override fun update(originalFile: File, updatedPattern: PO12Pattern): File {
